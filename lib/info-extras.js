...
exports.getLikes = info => {
  try {
    ...
    // It doesn't work to get likes, at least in my region
    ...
    // Working in my region - NeuNoRo 7/12/2023 3:00 AM 
    let like = buttons.find(b => b.segmentedLikeDislikeButtonViewModel).segmentedLikeDislikeButtonViewModel.likeButtonViewModel.likeButtonViewModel.toggleButtonViewModel.toggleButtonViewModel;
    return parseInt(like.toggledButtonViewModel.buttonViewModel.accessibilityText.replace(/\D+/g, ''));
  } catch (err) {
    return null;
  }
};
